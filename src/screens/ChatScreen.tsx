...
const styles = StyleSheet.create({
  ...
  composerInput: { flex: 1, color: theme.text, fontSize: 16, minHeight: 48, maxHeight: 150, paddingTop: 6, paddingBottom: 6 },
  composerDivider: { height: 1, backgroundColor: theme.border, marginVertical: 4 },
  ...
  composerSend: { width: 32, height: 32, borderRadius: 16, backgroundColor: theme.accent, alignItems: "center", justifyContent: "center" },
  composerStop: { width: 32, height: 32, borderRadius: 16, backgroundColor: theme.danger, alignItems: "center", justifyContent: "center" },
